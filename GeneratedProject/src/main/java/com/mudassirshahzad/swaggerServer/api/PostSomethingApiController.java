...
@Controller
public class PostSomethingApiController implements PostSomethingApi {
    ...
    public PostSomethingApiController(ObjectMapper objectMapper, HttpServletRequest request) {
